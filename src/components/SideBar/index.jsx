...
const SideBar = ({open, sideBarRef}) => {
  ...
  return (
    <Drawer variant="permanent" ref={sideBarRef} open={open} sx={{ display: {xs : open ? 'block': 'none', md: 'block'}, zIndex: 1, position: {xs: 'fixed', md: 'sticky'}, top: '64px', pt:0, height: 'calc(100vh - 64px)' }}>
      <List >
